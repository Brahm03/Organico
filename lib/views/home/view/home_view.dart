                  ...
                  children: [
                    CupertinoSearchTextField(
                      onTap: () => NavigationService.instance
                          .pushNamed(routeName: '/search_view', args: context),
                          ...
                          itemBuilder: (_, __) {
                            return InkWell(
                                onTap: () => NavigationService.instance
                                    .pushNamed(
                                        routeName: '/info_view',
                                        args: DataService.instance.alldata[1]
                                            [__]),
                                child: ProductBigWidget(
                                    name: DataService
                                        .instance.alldata[0][__]['name']
                                        .toString(),
                                    cost: DataService
                                        .instance.alldata[0][__]['cost']
                                        .toString(),
                                    image_url: DataService
                                        .instance.alldata[0][__]['image_url']
                                        .toString(),
                                    market: DataService
                                        .instance.alldata[0][__]['market']
                                        .toString(),
